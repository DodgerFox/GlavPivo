...
function CenterControl(controlDiv, map) {
  ...
  controlUI.addEventListener('click', function() {
    mapAboutUs.setCenter(pointSingleMarket);
  });
}
...
function initMap() {
  mapAboutUs = new google.maps.Map(document.getElementById('map-aboutUs'), {
  ...
  var zoomControl = new ZoomControl(zoomControlDiv, mapAboutUs);
    ...
    mapAboutUs.controls[google.maps.ControlPosition.RIGHT_BOTTOM].push(zoomControlDiv);
    mapAboutUs.controls[google.maps.ControlPosition.TOP_LEFT].push(centerControlDiv); 
  }
  else{
    zoomControlDiv.style.paddingRight = '32px';
