var mapMarkets;
var glavpivoPoint = {lat: 59.948192, lng: 30.2323043};
stylesMap = [
    {
...
function CenterControl(controlDiv, map) {
  ...
  controlUI.addEventListener('click', function() {
    mapMarkets.setCenter(glavpivoPoint);
  });
}
...
function initMap() {
  mapMarkets = new google.maps.Map(document.getElementById('map-netMarkets'), {
    center: glavpivoPoint,
    zoom: 15,
    scrollwheel: false,
  ...
  centerControlDiv.index = 1;
    ...
    if (window.innerWidth > 750) {
    centerControlDiv.style.paddingRight = '40px';
    centerControlDiv.style.paddingTop = '60px';
    zoomControlDiv.style.paddingRight = '40px';
    zoomControlDiv.style.paddingBottom = '190px';
    mapMarkets.controls[google.maps.ControlPosition.RIGHT_BOTTOM].push(zoomControlDiv);
    mapMarkets.controls[google.maps.ControlPosition.TOP_RIGHT].push(centerControlDiv); 
  }
  else{
